...
public class DataModel {
  ...
  private static Datum[] SampleDataForGlide() {
    return new Datum[] {
        new Decade(1800), new GlideArtist("Richard James Lane",
        ...
        new GlideArtist("Louis and Fritz Wolff",
        ...
        new Decade(1810), new GlideArtist("\u00C9mile Lassalle",
        ...
        new GlideArtist("Anastas Jovanovi\u0107",
        ...
        new Decade(1830), new GlideArtist("Gaston Marichal",
        ...
        new Decade(1850), new GlideArtist("Vincent van Gogh",
        ...
        new GlideArtist("Juan Comba Garc\u00EDa", //Garcia
